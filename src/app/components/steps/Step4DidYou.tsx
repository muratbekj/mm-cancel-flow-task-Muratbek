...
export default function Step4DidYou({
  onNext,
  onBack,
  onClose,
  updateUserResponse
  ...
  const handleYes = () => {
    updateUserResponse('didYouUseSupport', true);
    onNext('step5-did-you');
  };

  const handleNo = () => {
    updateUserResponse('didYouUseSupport', false);
    onNext('step5-did-you');
  };
  ...
  return (
    <div className="p-6">
      ...
      {/* Hero Image */}
      <div className="mb-6">
        <div className="w-full h-32 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg flex items-center justify-center">
      ...
      <div className="text-center mb-8">
        <h3 className="text-lg font-medium text-gray-900 mb-3">
          Did you try our customer support?
        </h3>
        <p className="text-gray-600 mb-6">
          Our support team is available 24/7 to help with any issues. 
          They can often resolve problems quickly and get you back on track.
        </p>
      </div>
      ...
      <div className="mt-8">
        ...
        <p className="text-xs text-gray-500 text-center mt-2">Step 4 of 11</p>
      </div>
    </div>
  );
}
